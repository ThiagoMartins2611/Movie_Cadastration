...
document.getElementById('filmes').addEventListener('click', function(e) {
    ...
    if (card) {
        ...
        const idfilme = filme.idfilme;
        const userid = filme.userid;
        ...
        const svgComentario = document.getElementById("svgComentario");
        svgComentario.onclick = () =>{
            window.location.href = "paginaDeComentarios.html"
        }
    }
